...
password = 'akllioknaerdhujti' # the 16 digit character which we got from myaccounts.google.com
...
#send_mail(to_emails=['i51vignesh@gmail.com','spacemonkey@gmail.com'],attachment='/home/spacemonkey/mr_bean.jpg') #note that we need pass the mail as a list data type
